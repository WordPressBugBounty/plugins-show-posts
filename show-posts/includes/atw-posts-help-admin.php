...
<p style="color:green;font-weight:bold;font-size:140%;">
    <?php echo esc_html($title); ?> <a href="<?php echo esc_html($t_dir); ?>" target="_blank"
                                       title="Weaver Plugins Help File">Help Document</a>
    <span style="font-size:80%;margin-left:20px;">Visit the official
    <a href="http://forum.weavertheme.com/categories/atw-show-posts-and-atw-show-sliders"
...
<p>
    The recommended way to display posts is to specify all the filter selection options on the <em>Filter</em> tab, and
    use the
...
<ol>
    ...
    <li>Use a meaningful name and <em>Create New Filter</em> to define a filter. You can define as many filters as you
        need.
    </li>
    ...
    <li>Save Options</li>
    <li>Display posts using <strong>[show_posts filter=filter-name]</strong>. There is an "Add [show_posts]" button on
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    if (sessionStorage.getItem("scrollTop")) {
        window.scrollTo(0, parseInt(sessionStorage.getItem("scrollTop")));
        sessionStorage.removeItem("scrollTop");
    }

    // Save scroll when any submit button is clicked
